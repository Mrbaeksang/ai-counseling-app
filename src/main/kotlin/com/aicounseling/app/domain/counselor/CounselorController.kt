...
class CounselorController(
    ...
    fun getCounselor(
        ...
        val response = CounselorDetailResponse(
            id = counselor.id,
            name = counselor.name,
    ...
    fun addFavorite(
        ...
        val user = userService.getUser(userId)
        val counselor = counselorService.addFavorite(
            user = user,
            counselorId = id
        )
    ...
    fun removeFavorite(
        ...
        val user = userService.getUser(userId)
        val counselor = counselorService.removeFavorite(
            user = user,
            counselorId = id
        )
